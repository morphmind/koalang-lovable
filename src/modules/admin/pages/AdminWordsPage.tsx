...
export const AdminWordsPage: React.FC = () => {
  return (
    <div>
      <h1 className="text-2xl font-bold mb-6">Word Management</h1>
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Users Learning</th>
